...
public class BinarySearchTreeTest {
    ...
    @Test
    public void testContainsShouldSuccessfullyReturnTrue(){
        BinarySearchTree<Integer> num = new BinarySearchTree<>();
        num.insert(5);
        num.insert(4);
        num.insert(2);
        num.insert(1);
        assertTrue(num.contains(5));
        assertTrue(num.contains(4));
        assertTrue(num.contains(2));
       assertTrue(num.contains(1));

    }
    @Test
    public void testContainsShouldSuccessfullyReturnFalse(){
        BinarySearchTree<Integer> num = new BinarySearchTree<>();
        num.insert(5);
